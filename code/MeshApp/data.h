...
signals:
    void __CalculateProgress_set(int);
    void __TimerLabel_set(struct Timer* timer);
    void __iter_set(int _iter);
    void __rms_set(int _rms);

private:
    void setCalculateProgress(int value);
    void setTimerLabel(struct Timer* timer);
    void setIterLabel(int _iter);
    void setRmsLabel(int Rms);
